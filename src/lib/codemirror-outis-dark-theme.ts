// Outis-Dark CodeMirror theme — replaces @codemirror/theme-one-dark.
//
...
// OUTIS_DARK_THEME_SPEC.md for the rest of the design system.
//
...
export const outisDarkEditorTheme = /*@__PURE__*/ EditorView.theme(
	{
		...
		// (OUTIS_DARK_CONSISTENCY_SPEC.md Finding 1), so code read visibly
...
const outisDarkHighlightStyle = /*@__PURE__*/ HighlightStyle.define([
...
export const outisDark = [outisDarkEditorTheme, syntaxHighlighting(outisDarkHighlightStyle)];
